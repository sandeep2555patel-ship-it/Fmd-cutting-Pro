    ...
    <div className="flex flex-col space-y-4">
      <div className="flex items-center justify-between text-white text-xs">
        ...
        <div className="flex items-center space-x-4">
          <button className="text-white hover:text-[#2fe4b9] transition-colors">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"/><path d="M3 3v5h5"/></svg>
          </button>
          <button className="bg-[#222] px-3 py-1.5 rounded flex items-center space-x-1 border border-[#333]">
            <span>Preset</span>
      ...
      <div className="px-4 pb-2">
        <div ref={containerRef} className="bg-[#181818] border border-[#333] rounded-lg p-0 relative h-48 w-full touch-none group select-none shadow-inner">
            ...
            <div className="relative w-full h-full">
              ...
              {points.map((p, i) => (
                ...
                >
                  ...
                  {draggingIdx === i && (
                    <div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-[#333] text-white text-[11px] font-medium px-2 py-1 rounded shadow-lg whitespace-nowrap">
                      {p.y.toFixed(1)}x
                    </div>
                  )}
                </div>
          ...
          <div className="p-4 space-y-6">
            {activeSubTab === 'basic' && (
              <>
                ...
                <div className="space-y-4 mb-4 pb-4 border-b border-[#222]">
                  <div className="flex justify-between text-gray-400">
                    <div className="flex items-center space-x-2">
                       <Clock size={14} className="text-[#2fe4b9]" />
                  ...
                  <Slider 
                    ...
                    className="w-full accent-[#2fe4b9]" 
                  />
                  ...
                  {selectedClip?.keyframes && selectedClip.keyframes.length > 0 && (
                     <div className="flex flex-col space-y-1 mt-2">
                        ...
                        {selectedClip.keyframes.map((kf, i) => (
                           <div key={i} className={`flex items-center justify-between p-1.5 rounded bg-[#111] border ${kf.time === scrubTime ? 'border-[#2fe4b9]/50' : 'border-[#333]'}`}>
                ...
                <div className="space-y-4 pt-4 border-t border-[#222]">
                  <div className="flex items-center justify-between pb-3 border-b border-[#222]">
                    <div className="flex flex-col">
                      <div className="font-semibold text-[#2fe4b9]">AI Semantic Isolation</div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-[#111] border border-[#2fe4b9]/30 rounded-lg p-3 space-y-3 relative overflow-hidden">
                    ...
                    <div className="flex justify-between text-gray-400 text-xs">
                      <span>Intensity</span>
                      <span className="text-[#2fe4b9] font-medium">{selectedClip?.enhanceIntensity ?? 85}%</span>
                    </div>
        ...
        <div className="flex-1 overflow-y-auto min-h-0 p-4 pb-24 space-y-6">
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Slider normalValue={60} defaultValue={60} min={0} max={100} className="w-full accent-[#2fe4b9]" />
            </div>
        ...
        <div className="flex-1 overflow-y-auto min-h-0 p-4 pb-24 space-y-6">
          <div className="space-y-4">
            <div className="flex items-center space-x-2 text-gray-300 font-semibold mb-2">
              <Mic2 size={14} className="text-[#2fe4b9]" />
        ...
        <div className="flex-1 overflow-y-auto min-h-0 p-4 pb-24 space-y-6">
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-2 mt-4">
              <button className="py-2 bg-[#2fe4b9] text-black font-medium rounded hover:bg-[#2fe4b9]/90 transition-colors">
                Auto Remix
              </button>
              <button className="py-2 bg-[#222] text-white font-medium rounded hover:bg-[#333] transition-colors border border-[#333]">
                Extract Beats
              </button>
            </div>
              ...
              {VIDEO_EFFECTS.map(fx => {
                ...
                return (
                  <div 
                    ...
                    className={`aspect-video rounded relative overflow-hidden flex flex-col items-center justify-center border ${isActive ? 'border-[#2fe4b9] text-[#2fe4b9]' : 'border-[#333] text-gray-400 hover:border-[#2fe4b9] hover:text-white'} cursor-pointer transition-colors text-xs font-medium`}
                  >
      ...
      {activeTab === 'caption' && (
        <div className="flex-1 overflow-y-auto min-h-0 p-4 pb-24 space-y-6">
          <div className="space-y-4">
            ...
            <button className="w-full py-2 bg-[#2fe4b9] text-black font-medium rounded hover:bg-[#2fe4b9]/90 transition-colors">
              Generate Captions
            </button>
          </div>
        </div>
      ...
      {activeTab === 'crop' && (
        <div className="flex-1 overflow-y-auto min-h-0 p-4 pb-24 space-y-6">
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-2">
               <button className="py-2 bg-[#222] text-gray-400 rounded hover:text-white border border-[#333] hover:border-[#2fe4b9]">Free</button>
               <button className="py-2 bg-[#222] text-gray-400 rounded hover:text-white border border-[#333] hover:border-[#2fe4b9]">1:1</button>
               <button className="py-2 bg-[#222] text-gray-400 rounded hover:text-white border border-[#333] hover:border-[#2fe4b9]">16:9</button>
               <button className="py-2 bg-[#222] text-gray-400 rounded hover:text-white border border-[#333] hover:border-[#2fe4b9]">9:16</button>
               <button className="py-2 bg-[#222] text-gray-400 rounded hover:text-white border border-[#333] hover:border-[#2fe4b9]">4:3</button>
               <button className="py-2 bg-[#222] text-gray-400 rounded hover:text-white border border-[#333] hover:border-[#2fe4b9]">3:4</button>
            </div>
          </div>
        </div>
      )}
        ...
        <div className="flex-1 overflow-y-auto min-h-0 p-4 pb-24 space-y-6">
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-4 gap-2">
               <div className="aspect-square bg-transparent rounded border border-[#333] flex items-center justify-center cursor-pointer text-gray-500 text-xs">None</div>
               <div className="aspect-square bg-black rounded border border-[#333] cursor-pointer"></div>
               <div className="aspect-square bg-white rounded border border-[#333] cursor-pointer"></div>
               <div className="aspect-square bg-red-500 rounded border border-[#333] cursor-pointer"></div>
               <div className="aspect-square bg-blue-500 rounded border border-[#333] cursor-pointer"></div>
               <div className="aspect-square bg-green-500 rounded border border-[#333] cursor-pointer"></div>
               <div className="aspect-square bg-yellow-500 rounded border border-[#333] cursor-pointer"></div>
               <div className="aspect-square bg-purple-500 rounded border border-[#333] cursor-pointer"></div>
            </div>
          </div>
        </div>
      )}
        ...
        <div className="flex-1 overflow-y-auto min-h-0 p-4 pb-24 space-y-6">
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Slider normalValue={0} defaultValue={0} min={0} max={100} className="w-full accent-[#2fe4b9]" />
            </div>
            <div className="pt-4 font-medium text-gray-400">Color</div>
            <div className="grid grid-cols-6 gap-2">
               <div className="aspect-square bg-white rounded-full border border-[#333] cursor-pointer"></div>
               <div className="aspect-square bg-black rounded-full border border-[#333] cursor-pointer"></div>
               <div className="aspect-square bg-red-500 rounded-full border border-[#333] cursor-pointer"></div>
               <div className="aspect-square bg-blue-500 rounded-full border border-[#333] cursor-pointer"></div>
               <div className="aspect-square bg-green-500 rounded-full border border-[#333] cursor-pointer"></div>
               <div className="aspect-square bg-yellow-500 rounded-full border border-[#333] cursor-pointer"></div>
            </div>
          </div>
        </div>
      )}
          ...
          <div className="flex space-x-4 px-4 pt-3 pb-2 border-b border-[#222]">
            {['Normal', 'Curve'].map(tab => (
              <button 
                ...
                className={`transition-colors ${
                  activeSpeedTab === tab.toLowerCase() ? 'text-white font-medium border-b-2 border-[#2fe4b9] pb-1' : 'text-gray-500 hover:text-gray-300 pb-1'
                }`}
              >
                {tab}
              </button>
            ...
            {activeSpeedTab === 'normal' && (
              <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative w-full py-2">
                      <Slider 
                        ...
                        className="w-full accent-[#2fe4b9] relative z-10 bg-transparent" 
                      />
                      <div 
                ...
                <div className="flex items-center justify-between pt-2">
                  ...
                  <div className="bg-[#111] border border-[#333] rounded px-2 py-1 text-white">
                ...
                <div className="grid grid-cols-3 gap-2">
                  {['None', 'Custom', 'Montage', 'Hero', 'Bullet', 'Jump Cut'].map(curve => (
                    <button 
                      ...
                      className={`p-2 bg-[#111] border ${selectedClip?.speedCurve === curve ? 'border-[#2fe4b9] text-[#2fe4b9]' : 'border-[#333] hover:border-[#2fe4b9] text-gray-400 hover:text-white'} rounded text-[10px] flex flex-col items-center justify-center space-y-1`}
                    >
